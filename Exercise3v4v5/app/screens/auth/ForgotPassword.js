...
export default function ForgotPassword({ navigation }) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (data.statusCode === 404) {
                        setEmailError(
                            "Email này chưa được sử dụng, bạn hãy đăng ký tài khoản để tham gia"
                        );
                    } else {
    ...
    return (
        <View className="flex-1 bg-white px-5 justify-between">
            ...
            <View>
                <Text className="text-2xl font-bold text-gray-800 mt-10 mb-8">
                    Quên mật khẩu
                </Text>
                <Text className="text-base text-gray-800 mb-5">
                    Vui lòng nhập email đăng ký của bạn. Chúng tôi sẽ gửi hướng
                    dẫn đổi mật khẩu tới email này.
                </Text>
                <View
